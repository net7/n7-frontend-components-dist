...
const ɵ0$3 = ['transcription', 'sferamundi', 'commentary'];
...
const ɵ0$4 = (f, s) => f.content.charAt(0) === s.content.charAt(0), ɵ1$1 = (data, element) => `<div class="tooltip">${element.title}</div>`, ɵ2 = (timeline) => timeline;
const TIMELINE_MOCK = {
