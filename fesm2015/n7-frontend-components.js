...
import { transition, easeCubicInOut, scaleOrdinal, schemeTableau10, scaleLinear, extent, max, pack, hierarchy, shuffle, select } from 'd3';
...
class BubbleChartComponent {
    constructor() {
         ...
         */
        () => {
            const { containerId, data, height, width, selected, transition: transition$$1, sizeRange, colorMatch, shuffle: shuffle$$1 } = this.data;
            /** @type {?} */
