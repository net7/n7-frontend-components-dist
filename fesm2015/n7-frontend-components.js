...
class BubbleChartComponent {
    constructor() {
         ...
         */
        () => {
            const { containerId, data, height, width, selected, transition: transition$1, colorMatch, shuffle: shuffle$1, fontRendering } = this.data;
            /** @type {?} */
            ...
            (children) => pack()
                ...
                .padding(1.5)(hierarchy({ children }).sum((/**
             * @param {?} d
             * @return {?}
             */
            (d) => sizeScale(d.count)))));
