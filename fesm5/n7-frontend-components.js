        ...
        function () {
            ...
            function (data) {
                return pack()
                    ...
                    .padding(1.5)(hierarchy({ children: data }).sum((/**
                 * @param {?} d
                 * @return {?}
                 */
            ...
            function () {
                if (typeof shuffle$1 == 'undefined' || shuffle$1) {
                    ...
                    ;
                    return pack$1(shuffle(shuffData));
                }
